...
<div id="section-shortcode-display">
	...
	<div class="section-shortcode">
		<span id="ection-shortcode"><pre>[section name="<?php echo $name; ?>" template="default"]</pre></span>
	</div>
	<div class="section-function">
		<span id="section-function"><pre>&lt;?php show_section('<?php echo $name; ?>', array('template' => 'default')); ?&gt;</pre></span>
	</div>
</div>